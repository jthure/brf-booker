...
resource "aws_security_group" "ec2" {
  name        = "brf-booker-ec2-sg"
  description = "Security group for EC2 instances running the Next.js app"
  ...
  # Allow the app port (Next.js default is 3000)
  ingress {
    from_port   = 3000
    to_port     = 3000
    protocol    = "tcp"
